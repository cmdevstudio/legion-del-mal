...
![Workflow](https://img.shields.io/github/actions/workflow/status/cmdevstudio/legion-del-mal/ci.yml)
...
## ¿Quiénes somos? - Desde Remoto y Local - Y ahora en VSCODE Online
...
📄 README.md        → Información de contacto de la organización
📄 nuevas-misiones.yaml    → Estado global de las nuevas misiones, no aprobadas por el consejo
```
...
| 🧠 Miembro Honorario      | Darkseid   | Dueño del universo y de todas las cosas         |
